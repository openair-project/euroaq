...
**euroaq** is an R wrapper for the European Environment Agency’s [Air
Quality Download Service
API](https://eeadmz1-downloads-webapp.azurewebsites.net/), which gives
programmatic access to data flows E1a and E2a, as well as historic
‘Airbase’ data.
...
**euroaq** imports air quality data from the EEA’s Air Quality Downloads
service API.
...
All **euroaq** functions are fully documented; access documentation
...
The development version of **euroaq** can be installed from GitHub using
...
🏛️ **euroaq** is primarily maintained by [Jack
Davison](https://github.com/jack-davison).

📃 **euroaq** is licensed under the [MIT
License](https://openair-project.github.io/euroaq/LICENSE.html).

🧑‍💻 Contributions are welcome from the wider community. See the
[contributing
guide](https://openair-project.github.io/euroaq/CONTRIBUTING.html) and
[code of
conduct](https://openair-project.github.io/euroaq/CODE_OF_CONDUCT.html)
